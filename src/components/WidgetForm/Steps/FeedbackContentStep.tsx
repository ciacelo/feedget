...
export default function FeedbackContentStep({ feedbackType, onFeedbackRestartRequest, onFeedbackSent }: FeedbackContentStepProps) {
  ...
  return (
    ...
    <header>
      ...
      <span className='text-xl leading-6 flex items-center gap-2 px-2'>
